...
public class StudentController {
    ...
    public Student getStudentById(@PathVariable("id") Long pkStudentID) {
        Student student = studentService.getStudentById(pkStudentID);
        if (student == null) {
            throw new StudentNotFoundException("Student with ID " + pkStudentID + " not found");
        }
        return student;
    }
    ...
    public Student updateStudent(@PathVariable Long pkStudentID, @RequestBody Student student) {
    ...
    public String deleteStudent(@PathVariable Long pkStudentID) {
